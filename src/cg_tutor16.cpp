...
// 着色器文件路径
static const char* vShaderFileName = "GLSL/vshader16.glsl";
static const char* fshaderFileName = "GLSL/fshader16.glsl";
...
static void renderSceneCB() {
    ...
    pShader -> setVec3f("gEyeWorldPos", pCamera->getPos());
...
static void initMesh() {
    ...
    pMesh = new Mesh(vector<Vertex>(
        vertices, vertices + vertexCount), 
        vector<GLuint>(indices, indices + indexCount), 
        textures);
...
static void initLight() {
    ...
    dirLight.direction = Vec3f(0.5f, 0.0f, 1.0f);
...
static void initMaterial() {
    ...
    pShader -> setFloat("material.SpecularIntensity", mat.specularIntensity);
    pShader -> setFloat("material.SpecularPower", mat.specularPower);
}
...
void testOGLTutorial() {
    glw::openGlWindow(
        renderSceneCB, 
        "OpenGL Tutorial 16 - Specular Lighting ", 
        init, 
        NULL, 
        renderSceneCB,
        true, 
